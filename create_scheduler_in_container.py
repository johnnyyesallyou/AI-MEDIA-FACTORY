...
scheduler_content = '''import logging
import os
import asyncio
...
# Записываем файл с правильной индентацией (Linux-style, LF)
f = pathlib.Path('/app/backend/automation/scheduler.py')
f.write_text(scheduler_content, encoding='utf-8', newline='\n')

print('✅ scheduler.py создан с правильной индентацией (LF, пробелы)')
