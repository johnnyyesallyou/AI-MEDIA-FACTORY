import pathlib
p = pathlib.Path('./frontend/src/pages/Automation.tsx')

new_page = '''import React, { useEffect, useState } from 'react';
...
print('OK: Automation.tsx rewritten as Scheduler Dashboard')