...
# Универсальная модалка, которая рендерит разные поля в зависимости от platformType
platform_modal = '''
...
# Вставляем перед Modal for schedule
if 'showPlatformModal' not in s:
    ...
    print("✅ Добавлена универсальная модалка для VK/YouTube/Dzen")
